...
mod tests {
    ...
    fn test_quit_keys() {
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('q'))),
            Some(AppEvent::Quit)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Esc)),
            Some(AppEvent::Quit)
        );
    }
    ...
    fn test_demo_select_keys() {
        for (ch, idx) in [
            ...
            assert_eq!(
                key_event_to_app_event(key(KeyCode::Char(ch))),
                Some(AppEvent::SelectDemo(idx))
            );
        }
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('0'))),
            Some(AppEvent::SelectDemo(9))
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('a'))),
            Some(AppEvent::SelectDemo(10))
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('A'))),
            Some(AppEvent::SelectDemo(10))
        ...
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('b'))),
            Some(AppEvent::SelectDemo(11))
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('B'))),
            Some(AppEvent::SelectDemo(11))
        ...
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('c'))),
            Some(AppEvent::SelectDemo(12))
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('C'))),
            Some(AppEvent::SelectDemo(12))
        ...
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('d'))),
            Some(AppEvent::SelectDemo(13))
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('D'))),
            Some(AppEvent::SelectDemo(13))
        ...
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('f'))),
            Some(AppEvent::SelectDemo(14))
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('F'))),
            Some(AppEvent::SelectDemo(14))
    ...
    fn test_nav_keys() {
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Left)),
            Some(AppEvent::PrevDemo)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('h'))),
            Some(AppEvent::PrevDemo)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Right)),
            Some(AppEvent::NextDemo)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('l'))),
            Some(AppEvent::NextDemo)
        );
    }
    ...
    fn test_action_keys() {
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char(' '))),
            Some(AppEvent::TogglePause)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('r'))),
            Some(AppEvent::Reset)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('R'))),
        ...
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('e'))),
            Some(AppEvent::ToggleExplanation)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('E'))),
            Some(AppEvent::ToggleExplanation)
        ...
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('s'))),
            Some(AppEvent::Screenshot)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('S'))),
            Some(AppEvent::Screenshot)
        ...
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('v'))),
            Some(AppEvent::ToggleVsMode)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('V'))),
            Some(AppEvent::ToggleVsMode)
    ...
    fn test_scroll_up_keys() {
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Up)),
            Some(AppEvent::ScrollUp)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('k'))),
            Some(AppEvent::ScrollUp)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('K'))),
    ...
    fn test_scroll_down_keys() {
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Down)),
            Some(AppEvent::ScrollDown)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('j'))),
            Some(AppEvent::ScrollDown)
        );
        assert_eq!(
            key_event_to_app_event(key(KeyCode::Char('J'))),
